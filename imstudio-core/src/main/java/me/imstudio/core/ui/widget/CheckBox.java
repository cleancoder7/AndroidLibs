...
public class CheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.CheckBox_ims_colorTick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.CheckBox_ims_duration, DEF_ANIM_DURATION);
    ...
    public void setChecked(boolean checked) {
        ...
        invalidate();
        if (mListener != null) {
            mListener.onCheckedChanged(CheckBox.this, mChecked);
        }
    }
